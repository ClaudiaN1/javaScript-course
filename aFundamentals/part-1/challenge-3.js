...
if ((dolphinsTeamScore > koalasTeamScore) && (dolphinsTeamScore >= 100)) {
    console.log('Dolphins Team is the winner');
} else if ((koalasTeamScore > dolphinsTeamScore) && (koalasTeamScore >= 100)) {
    console.log('Koalas Team is the winner');
} else if (dolphinsTeamScore === koalasTeamScore) {
    console.log('It is equality');
} else if ((dolphinsTeamScore === koalasTeamScore) && (dolphinsTeamScore < 100 && koalasTeamScore < 100)) {
    console.log('It is equality, but the score is under 100 points => NO Winner');
} else {
    console.log('Neither team has a high enough score to win');
}
